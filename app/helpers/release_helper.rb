module ReleaseHelper
  def link_to_page(release_id:, page:, teams_per_page:, city:)
  ...
  def link_to_last_page(release_id:, teams_in_release:, teams_per_page:, city:)
  ...
  def link_to_previous_page(release_id:, current_top:, current_bottom:, city:)
  ...
  def link_to_next_page(release_id:, current_top:, current_bottom:, city:)
    teams_per_page = current_bottom - current_top + 1
